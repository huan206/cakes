    ...
    <div class="container">
        ...
        <form role="form" style="width:55%;" action="/adminedit" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="type" id="1" value="{{ $product->id_type }}"
                    placeholder="Enter type">
            </div>

            <div class="form-group">
                <label for="2"> Price </label>
                <input type="text" class="form-control" name="unit_price" id="2" placeholder="Enter unit price "
                    value="{{ $product->unit_price }}">
            </div>

            <div class="form-group">
                <label for="3"> Description</label>
                <input type="text" class="form-control" name="description" id="3" value="{{ $product->description }}"
                    placeholder="Enter unit price">
            </div>

            <div class=" form-group ">
                <label for="4"> Promotion </label>
                <input type=" text " class="form-control" name="promotion_price" id="4"
                    value="{{ $product->promotion_price }}" placeholder="Enter promotion price">
            </div>

            <div class=" form-group">
                <label for="5"> Unit</label>
                <input type="text" class="form-control" name="unit" id="5" value="{{ $product->unit }}"
                    placeholder="Enter unit">
            </div>

            <div class=" form-group ">
                <label for="6"> New </label>
                <input type="number" class="form-control" name="new" id="6" value="{{ $product->new }}"
